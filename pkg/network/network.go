<<<<<<< HEAD:setting/network.go
<<<<<<< Updated upstream:setting/network.go
package setting
=======
=======
>>>>>>> 137f07b (新增 1.添加viper配置框架以及zap日志框架 修改 1.将原setting包改为pkg包,并将不同功能的模块函数各自独立为一个单独包):pkg/network/network.go
/*
...
<<<<<<< HEAD:setting/network.go
@LastEditTime: 2021-09-14 19:32:08
@FilePath: /goAdapter-Raw/pkg/network/network.go
*/
package network
>>>>>>> Stashed changes:pkg/network/network.go
=======
@LastEditTime: 2021-09-14 14:24:11
@FilePath: /goAdapter-Raw/pkg/network/network.go
*/
package network
>>>>>>> 137f07b (新增 1.添加viper配置框架以及zap日志框架 修改 1.将原setting包改为pkg包,并将不同功能的模块函数各自独立为一个单独包):pkg/network/network.go
...
func NetworkParaRead() bool {
	...
	if system.FileExist(fileDir) == true {
