...
func GetLogParam(context *gin.Context) {

	aParam := &struct {
		Code    string
		Message string
		Data    mylog.LoggerParamTemplate
	}{}

	aParam.Code = "0"
	aParam.Message = ""
	aParam.Data = *mylog.LoggerParam

	sJson, _ := json.Marshal(aParam)
	context.String(http.StatusOK, string(sJson))
}

func SetLogParam(context *gin.Context) {
	...
	logParam := &mylog.LoggerParamTemplate{}
	...
	mylog.LoggerParam.WriteParamToJson(logParam)
...
func GetLogFilesInfo(context *gin.Context) {
	...
	if err != nil {
		mylog.Logger.Errorf("readLogFileDir err %v", err)
		aParam.Code = "1"
...
func DeleteLogFile(context *gin.Context) {
	aParam := &struct {
		Code    string
		Message string
		Data    string
...
func GetLogFile(context *gin.Context) {
