...
type MQTTHuaweiValueTemplate struct {
	Value interface{}
	Name  string
}
...
type MQTTHuaweiNodeValueTemplate struct {
	...
	ValueMap   []MQTTHuaweiValueTemplate
}
...
func MQTTHuaweiGWPropertyPost(client MQTT.Client, gw MQTTHuaweiRegisterTemplate, valueMap []MQTTHuaweiValueTemplate) int {
...
func (r *ReportServiceParamHuaweiTemplate) GWPropertyPost() {
	...
	mqttHuaweiValue.Name = "MemTotal"
	mqttHuaweiValue.Value = setting.SystemState.MemTotal
	valueMap = append(valueMap, mqttHuaweiValue)

	mqttHuaweiValue.Name = "MemUse"
	mqttHuaweiValue.Value = setting.SystemState.MemUse
	valueMap = append(valueMap, mqttHuaweiValue)

	mqttHuaweiValue.Name = "DiskTotal"
	mqttHuaweiValue.Value = setting.SystemState.DiskTotal
	valueMap = append(valueMap, mqttHuaweiValue)

	mqttHuaweiValue.Name = "DiskUse"
	mqttHuaweiValue.Value = setting.SystemState.DiskUse
	valueMap = append(valueMap, mqttHuaweiValue)

	mqttHuaweiValue.Name = "Name"
	mqttHuaweiValue.Value = setting.SystemState.Name
	valueMap = append(valueMap, mqttHuaweiValue)

	mqttHuaweiValue.Name = "SN"
	mqttHuaweiValue.Value = setting.SystemState.SN
	valueMap = append(valueMap, mqttHuaweiValue)

	mqttHuaweiValue.Name = "HardVer"
	mqttHuaweiValue.Value = setting.SystemState.HardVer
	valueMap = append(valueMap, mqttHuaweiValue)

	mqttHuaweiValue.Name = "SoftVer"
	mqttHuaweiValue.Value = setting.SystemState.SoftVer
	valueMap = append(valueMap, mqttHuaweiValue)

	mqttHuaweiValue.Name = "SystemRTC"
	mqttHuaweiValue.Value = setting.SystemState.SystemRTC
	valueMap = append(valueMap, mqttHuaweiValue)

	mqttHuaweiValue.Name = "RunTime"
	mqttHuaweiValue.Value = setting.SystemState.RunTime
	valueMap = append(valueMap, mqttHuaweiValue)

	mqttHuaweiValue.Name = "DeviceOnline"
	mqttHuaweiValue.Value = setting.SystemState.DeviceOnline
	valueMap = append(valueMap, mqttHuaweiValue)

	mqttHuaweiValue.Name = "DevicePacketLoss"
	mqttHuaweiValue.Value = setting.SystemState.DevicePacketLoss
	valueMap = append(valueMap, mqttHuaweiValue)
	...
	MQTTHuaweiGWPropertyPost(r.GWParam.MQTTClient, mqttHuaweiRegister, valueMap)
							...
							if d.Name == n.Name {
								for _, v := range d.VariableMap {
									if len(v.Value) >= 1 {
										index := len(v.Value) - 1
										mqttHuaweiValue := MQTTHuaweiValueTemplate{}
										mqttHuaweiValue.Name = v.Name
										mqttHuaweiValue.Value = v.Value[index].Value
										valueMap = append(valueMap, mqttHuaweiValue)
									}
								}
